        ...
        <View className={s.chatbox}>
          <View className={s.contactDetails}>
            <View className={s.chatboxLeft}>
              <Image
                className={s.avatar}
                src="https://images.unsplash.com/photo-1494253109108-2e30c049369b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=3300&q=80"
              ></Image>
              <Badge />
            </View>
